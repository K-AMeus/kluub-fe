        ...
        <div className="relative min-h-screen flex flex-col text-white font-dela-gothic-one">
            <div className="relative py-12 sm:max-w-6xl w-full sm:mx-auto px-8 flex-grow">
                ...
                <div className="relative self-center inline-block w-full max-w-sm mx-auto mb-20 mt-10">
                    ...
                    <div className="relative z-10 p-6 bg-black border-2 border-white space-y-4 text-center">
                        <p className="text-[1.2rem] font-montserrat-bolder">Kluubike OÜ</p>
                        <p className="text-[1.2rem] font-montserrat-bolder">info@kluub.ee</p>
                        <p className="text-[1.2rem] font-montserrat-bolder">+372 1234 5678</p>
                    </div>
                </div>
                ...
                <div className="relative w-full max-w-5xl mx-auto mb-20">
                    ...
                    <div className="relative z-10 bg-black border-2 border-white p-8">
                        <h2 className="text-3xl font-dela-gothic-one text-left">
                            Our Vision
                        </h2>
                        <div className="w-60 border-t-2 border-white mt-2 mb-4"></div>
                ...
                <div className="relative w-full max-w-5xl mx-auto mb-20">
                    ...
                    <div className="relative z-10 bg-black border-2 border-white p-8">
                        ...
                        <div className="ml-auto w-60 border-t-2 border-white mt-2 mb-4"></div>
                ...
                <div className="mt-2 w-40 border-t-2 border-white mx-auto mb-20"></div>
                    ...
                    {[1, 2, 3, 4].map((member) => (
                        <div key={member} className="flex flex-col items-center space-y-2">
                            <div className="relative flex-shrink-0 w-[200px] h-[200px]">
                                <div className="relative z-10 bg-black border-2 border-[#E4DD3B] w-full h-full"></div>
                            </div>

...
const Events: FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* TOP PICKS marquee */}
      <div
        className="relative w-full flex overflow-x-hidden bg-[#E4DD3B] border-b-2 border-t-2 border-white text-black font-dela-gothic-one mb-5"
        style={{
          textShadow:
      ...
      <div
        ref={marqueeRef}
        className="pt-4 pb-2 relative w-full flex overflow-x-hidden bg-black border-t-2 border-b-2 border-white text-white font-dela-gothic-one scrollbar-hidden select-none cursor-grab active:cursor-grabbing"
      ...
      >
        {/* First Marquee pass */}
        <div className="animate-marquee5 whitespace-nowrap flex flex-row gap-6 py-0">
          {filteredEvents.map((event) => (
            <div
              key={event.id}
              className="relative group mb-4 mt-2 w-full"
            ...
            >
              ...
              <div className="relative inline-block items-center gap-4 z-10 p-4 border-2 border-white bg-black text-white font-montserrat-bolder">
                <div className="flex flex-row pt-10 items-end">
                  <div className="flex flex-col">
                    <div className="text-lg sm:text-2xl uppercase -mt-12">
                      {event.name}
                    </div>
        ...
        {/* Second Marquee pass */}
        <div className="top-0 animate-marquee6 whitespace-nowrap flex flex-row gap-6">
          {filteredEvents.map((event) => (
            <div
              key={event.id}
              className="relative group mb-4 mt-2 w-full"

...
const EventCard: FC<EventCardProps> = memo(({ event, imageUrl, onClick }) => {
  ...
  return (
    <div className="xs:w-100 md:w-150 lg:w-160 2xl:w-260 mx-auto relative group mb-8">
          ...
          <div className="w-full flex flex-col space-y-2">
              ...
              <div className="flex items-center">
                <svg
                  ...
                  className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#E4DD3B] flex-shrink-0"
                >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <svg
                    ...
                    stroke="#E4DD3B"
                    strokeWidth="0"
                    className="text-[#E4DD3B] flex-shrink-0"
                  >
